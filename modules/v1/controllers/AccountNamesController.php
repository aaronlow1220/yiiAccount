...
class AccountNamesController extends ActiveApiController
{
     ...
     * @return void
     */
    public function __construct($id, $module, private AccountSearchService $accountSearchService, private AccountCreateService $accountCreateService, $config = [])
    {
